...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 20, 2020 at 09:08 PM
...
INSERT INTO `bets` (`id`, `date`, `price`, `user_id`, `lot_id`) VALUES
(1, '2020-02-13 17:54:35', 12000, 1, 3),
...
INSERT INTO `categories` (`id`, `name`, `english_name`) VALUES
(1, 'Одежда', 'clothing'),
...
INSERT INTO `lots` (`id`, `name`, `description`, `image`, `price`, `date_start`, `date_end`, `step`, `favorite`, `user_id`, `winner_id`, `category_id`) VALUES
(1, 'Куртка для сноуборда DC Multiny Charocal', NULL, 'img/lot-5.jpg', 7500, '2020-01-26 10:59:10', '2020-02-25 00:00:00', 100, 0, 1, NULL, 1),
(3, '2014 Rossignol District Snowboard', NULL, 'img/lot-1.jpg', 11000, '2020-02-06 21:30:20', '2020-02-22 00:00:00', 100, 0, 1, 1, 3),
(7, 'DC Ply Mens 2014 Snowboard', 'some', 'uploads/lot-2.jpg', 160000, '2020-02-17 22:11:52', '2020-02-22 00:00:00', 1000, 0, 24, NULL, 3);
...
INSERT INTO `users` (`id`, `date`, `email`, `password`, `name`, `contacts`, `avatar`, `lots_id`, `bets_id`) VALUES
(1, '2020-01-26 10:54:57', 'ignat.v@gmail.com', '$2y$10$OqvsKHQwr0Wk6FMZDoHo1uHoXd4UdxJG/5UDtUiie00XaxMHrW8ka', 'Игнат', '89999999999', 'img/user.jpg', 3, 1),
...
(31, '2020-02-08 17:10:01', 'warrior07@mail.ru', '$2y$10$F6tFZ17FmfNf9wy5QJY7yOBaphvv1Mq0n.zzx5UeMVCxkHM3c4lfq', 'Руслан', '89782489826', 'uploads/cloud.jpg', NULL, NULL);
...
ALTER TABLE `lots` ADD FULLTEXT KEY `lots_ft_search` (`name`,`description`);
